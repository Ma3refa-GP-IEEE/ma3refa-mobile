        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              final currentQuestionData = widget.quizModel.questions[index];
                    ...
                    children: [
                      ...
                      if (isCurrentQuestionAnswered) ...[
                        Container(
                          padding: EdgeInsets.all(16.r),
                          decoration: BoxDecoration(
                            color: userAnswers[currentQuestionIndex].isCorrect
                        ...
                        CustomButton(
                          onPressed: () {
                            if (currentQuestionIndex ==
                              ...
                              // TODO: Handle Submit (e.g., call finishAndSubmitQuiz())
                            } else {
                              goToNextQuestion();
                            }
                          },
          ...
          if (isWrongAnswerTriggered)
            IgnorePointer(
              ...
              ).animate().fade(begin: 1.0, end: 0.0, duration: 600.ms),
            ),
          ConfettiWidget(
